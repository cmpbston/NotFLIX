...
app.get('/', (req, res) => {
     logsModel.find({},'_id accountID userName titleID userAction dateAndTime pointOfInteraction typeOfInteraction lastName', (err, logs) => {
...
app.post('/',  (req, res) => { 
  var new_logs_instance = new logsModel(req.body); 
